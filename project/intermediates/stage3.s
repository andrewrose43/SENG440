...
cordic_V_fixed_point:
	...
	rsble	r5, r6, #0		@z_tmp -= z_table[0] if y_tmp <= 0
	movgt	r5, r6			@z_tmp = z_table[0] if y_tmp > 0
	...
	rsble	r5, r6, r5		@subtract z_table[1] from z_tmp if old y_tmp<=0
	addgt	r5, r5, r6		@add z_table[1] to z_tmp if old y_tmp>0
	...
	rsble	r5, r6, r5		@subtract z_table[2] from z_tmp if old y_tmp<=0
	addgt	r5, r5, r6		@add z_table[2] to z_tmp if old y_tmp>0
